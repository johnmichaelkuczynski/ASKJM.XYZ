...
**Database:** v31_CONSCIOUSNESS_EPISTEMOLOGY - 1,564 positions from 41 works (includes College Papers Plus + McTaggart/consciousness/epistemic foundations material)
...
### Core Functionality
- **Semantic Search**: Indexes 1,564 philosophical positions using OpenAI embeddings (text-embedding-3-small model) for efficient retrieval.
...
- **Data Management**: Philosophical positions are stored in `data/KUCZYNSKI_PHILOSOPHICAL_DATABASE_v31_CONSCIOUSNESS_EPISTEMOLOGY.json` (1,564 positions). Pre-computed embeddings for these positions are cached in `data/position_embeddings.pkl`. Source texts from Kuczynski's works are stored in the `texts/` directory.
...
**2025-11-17**: Database v31 - Consciousness & Epistemic Foundations
- **DATABASE UPDATE v31**: Upgraded to v31_CONSCIOUSNESS_EPISTEMOLOGY with 1,564 positions from 41 works (6 more positions than v30)
- Added WORK-042 "McTaggart, Temporal Experience, and Epistemic Foundations" with 6 positions on:
  - **EP-160**: Conscious experience as epistemic foundation - theory-laden perception doesn't undermine justification because conscious experience remains foundational
  - **EP-161**: Phenomenology resists reduction to physical description - first-personal qualitative character has irreducible epistemic significance  
  - **EP-162**: Subjective standpoint as constitutive feature - background beliefs structure perception as part of constitutive framework, not defeaters
  - **META-055**: Modified Cartesian position on temporal consciousness - ego cogito experiences duration from within
  - **META-056**: Manifest vs. scientific images relationship - need frameworks accommodating both logical rigor and irreducible conscious experience
  - **META-057**: B-series generated by change - temporal order is outcome of generative process, not evidence of stasis
- **CRITICAL FOR EPISTEMOLOGY QUERIES**: These positions directly address how background beliefs relate to perceptual justification
- Database loaded with 1,564 total positions; 1,083 active after deduplication and empty-text filtering (up from 1,077 in v30)
- Regenerated OpenAI embeddings with proper 1:1 alignment (1,083 positions = 1,083 embeddings)
